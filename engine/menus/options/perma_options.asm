...
PermaOptionsPresets:
	...
	; Tourney
	permaoptionspreset Preset_TourneyName, ROCKETLESS_VAL | (SPINNERS_NONE << SPINNERS) | BETTER_ENC_SLOTS_VAL | (EXP_FORMULA_BLACKWHITE << EXP_FORMULA), BETTER_MARTS_VAL | EASY_TIN_TOWER_VAL, EASY_CLAIR_BADGE_VAL | DEX_AREA_BEEP_VAL | ROD_ALWAYS_SUCCEEDS_VAL | START_WITH_BIKE_VAL, 0
